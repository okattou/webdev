...
import (
	...
	"github.com/webdev/restapi/operations"
)

//go:generate swagger generate server --target ../../webdev --name WEBDEV --spec ../swagger.json --principal interface{}

func configureFlags(api *operations.WEBDEVAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.WEBDEVAPI) http.Handler {
	...
	api.ApplicationYmlProducer = runtime.ProducerFunc(func(w io.Writer, data interface{}) error {
		return errors.NotImplemented("applicationYml producer has not yet been implemented")
	})

	if api.DeleteUsersHandler == nil {
		api.DeleteUsersHandler = operations.DeleteUsersHandlerFunc(func(params operations.DeleteUsersParams) middleware.Responder {
			return middleware.NotImplemented("operation operations.DeleteUsers has not yet been implemented")
		})
	}
